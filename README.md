...
For Windows systems, this program is dependent on Python (version 3.8 or higher) being installed on your Windows system. Linux comes with Python 3 installed. MacOS may need to upgrade from Python 2.7 to Python 3.8 or higher.
