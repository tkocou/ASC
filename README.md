...
For Windows systems, this program is dependent on Python (version 3.8 or higher) being installed on your Windows system. Linux comes with Python 3 installed. MacOS might need to upgrade from Python 2.7 to Python 3.8 or higher.
...
Check the **Wiki** (near the top of the webpage) for more information.
